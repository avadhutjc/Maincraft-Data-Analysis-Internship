# 🎓 Maincraft Data Analysis (SQL) Internship - Task 1
...
# 🎓 Maincraft Data Analysis (SQL) Internship - Task 2

## Overview
<img width="955" height="633" alt="task2_prob_stmt" src="https://github.com/user-attachments/assets/d52f3e23-9a8c-44d1-b0f1-1c72ea2a66c9" />
...
LIMIT 3;
```
**Explanation:** Returns the top three students based on the highest average grade.
