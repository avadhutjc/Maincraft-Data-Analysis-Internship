...
This is the **core file** containing all database operations and SQL queries for the Student Management System. The file is organized into three main sections:

#### **Section 1️⃣ - Database Setup**
- ✅ Creates the `StudentManagement` database
- ✅ Defines the `students` table with the following schema:
  - `student_id` (SMALLINT UNSIGNED) - Unique student identifier
...
![Query 3.2 Output](https://github.com/user-attachments/assets/f5d2eefc-f5d2-41dc-bb22-c828dba81f52)
...
**Purpose:** Shows the database schema and table structure in the SQL console explorer.

**Details:**
- ✅ Database: `@SQL-Internship`
- ✅ Schema: `studentmanagement`
- ✅ Table: `students`
- ✅ Columns: 8 fields (student_id, name, gender, age, grade, math_score, science_score, english_score)
- ✅ Shows keys and indexes for database optimization
...
### **Commit 1:** `47d259d`
```
This file contain database & table creation, insert & alter statement and multiple working queries on created StudentManagement database.
```
...
### **Commit 2:** `a8ae782`
```
auto. updated sql dialects
```
- **Impact:** SQL dialect compatibility improvements
